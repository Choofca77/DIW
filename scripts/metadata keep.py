...
if __name__ == "__main__":
    folder_path = input("Enter the path to the folder containing media files: ")
    db_name = 'media_metadata.db'

    # Step 1: Create database and ensure required columns exist
    create_database(db_name)
    add_missing_columns(db_name)

    try:
        # Step 2: Process folder to extract metadata
